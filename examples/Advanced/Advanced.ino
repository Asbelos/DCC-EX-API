// This is an example of using several advanced features
// for handling special cases or different communication technologies
...
// this code is here to demonstrate use of the DCC API and other advanced techniques
...
void setup() {
  ...
  while(!DIAGSERIAL);
   ...
   // You can also override the default Timer1 in case this clashes with another libraray.  
   //  e.g. DCC::begin(STANDARD_MOTOR_SHIELD,2) to use Timer2
